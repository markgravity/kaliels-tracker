...
local function SetupTutorials()
	T.RegisterTutorial(helpName, {
		...
		{	-- 1
			...
			text = cTitle..KT.title.." (Classic)|r replaces default tracker and adds some features from WoW Retail to WoW BC Classic.\n\n"..
					"Some features:\n"..
		...
		{	-- 2
			...
			text = cTitle.."Header buttons|r\n\n"..
					...
					"Button |T"..mediaPath.."UI-KT-HeaderButtons:14:14:-1:2:32:64:16:30:0:14:209:170:0|t "..
		...
		{	-- 9
			text = cTitle.."         What's NEW in version |r|cffffffff2.2.0|r\n\n"..
					"- ADDED - Quest Item buttons next to the tracker (same as in the Retail addon"..
					offs.."version)\n"..
					"- UPDATED - Addon support - Questie 6.3.14\n"..
					"- UPDATED - Addon support - ElvUI 2.08\n"..
					"- UPDATED - Help (new page 5)\n\n"..

					cTitle.."WoW 2.5.1 - Known issues w/o solution|r\n"..
